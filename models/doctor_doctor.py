...
class doctor(models.Model):
    ...
    def modulo_instalado(self,nombre_modulo):

        modulo_instalado = self.env['ir.module.module'].search([('name', '=', nombre_modulo), ('state', '=', 'installed')])
        if modulo_instalado:
            return True
        return False
    ...
    def tipo_historia(self, modelo):
        ...
        if modelo == 'doctor_physiotherapy':
            return 'doctor.physiotherapy'
