...
report_sxw.report_sxw('report.doctor_clinical_laboratory_half', 'doctor.attentions',
					  'addons/l10n_co_doctor/report/doctor_clinical_laboratory_half.rml',
					  parser=doctor_clinical_laboratory, header=False)
