...
class doctor_referral(report_sxw.rml_parse):
...
report_sxw.report_sxw('report.doctor_referral_half', 'doctor.attentions',
					  'addons/l10n_co_doctor/report/doctor_referral_half.rml',
					  parser=doctor_referral, header=False)
