...
report_sxw.report_sxw('report.doctor_diagnostic_images_half', 'doctor.attentions',
					  'addons/l10n_co_doctor/report/doctor_diagnostic_images_half.rml',
					  parser=doctor_diagnostic_images, header=False)
