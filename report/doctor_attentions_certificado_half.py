...
report_sxw.report_sxw('report.doctor_attentions_certificado_half', 'doctor.attentions',
					  'addons/l10n_co_doctor/report/doctor_attentions_certificado_half.rml',
					  parser=doctor_attentions_certificado, header=False)
